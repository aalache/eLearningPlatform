...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white shadow-lg rounded-lg p-8 max-w-md text-center">
        ...
        <!-- Declined Message -->
        <h1 class="text-3xl font-bold text-red-600 mb-4">Payment Declined</h1>
        <p class="text-gray-700 mb-4">We were unable to process your payment. Please check your payment details or try
            again.</p>
        ...
        <div class="mt-6">
            <p class="text-gray-600">Need assistance? <a href="mailto:support@example.com"
