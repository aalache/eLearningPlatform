...
<nav x-data="{ open: false }" class="shodow-sm">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <div
                            ...
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-semibold rounded-md text-gray-300  hover:text-gray-400 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden  bg-black/50  sm:hidden">
