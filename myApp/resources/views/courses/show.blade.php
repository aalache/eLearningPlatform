             ...
             <div class="p-5 sm:p-10 space-y-6">
                 ...
                 <div class="h-full w-full grid gap-y-4 md:grid-cols-2 md:gap-2 ">
                     ...
                     <div class=" w-full space-y-5 overflow-y-scroll">
                         ...
                         <p data-aos="fade-right" data-aos-duration="400" data-aos-delay="700"
                             class="course-description text-gray-400   leading-relaxed">
                             {{ $course->description }}
                         </p>

                         <div class=" space-y-4">
                             @if (request()->routeIs('coach.*'))
                                 <x-courseComponents.course-link data-aos="fade-right" data-aos-duration="400"
                                     data-aos-delay="900"
                             ...
                             @if (request()->routeIs('user.*') && !Auth::user()->isEnrolledIn($course))
                                 <x-courseComponents.course-enrollbutton data-aos="fade-right" data-aos-duration="400"
                                     data-aos-delay="900" class="enroll-open-btn" type='submit'>
                                     Enroll Now
                     ...
                     <div data-aos="zoom-in-left" data-aos-duration="400" data-aos-delay="1000"
                         class="  shadow-lg w-full max-h-[350px] rounded-md">
                 ...
                 <div class="w-full flex flex-wrap  justify-evenly items-baseline  ">
                     <div data-aos="zoom-in" data-aos-duration="400" data-aos-delay="1100"
                         class=" w-fit  rounded-md  flex flex-col items-center justify-center space-y-2">
                     ...
                     <div data-aos="zoom-in" data-aos-duration="400" data-aos-delay="1200"
                         class=" w-fit  rounded-md  flex flex-col items-center justify-center space-y-2">
                     ...
                     <div data-aos="zoom-in" data-aos-duration="400" data-aos-delay="1300"
                         class=" w-fit  rounded-md  flex flex-col items-center justify-center space-y-2">
                     ...
                     <div data-aos="zoom-in" data-aos-duration="400" data-aos-delay="1400"
                         class="w-fit  rounded-md  flex flex-col items-center justify-center space-y-2">
                 ...
                 <div class=" space-y-8 pb-10">
                     <h2 data-aos="fade-right" data-aos-duration="400" data-aos-delay="1200"
                         class="text-xl  lg:text-2xl  border-l-4 border-orange-600 px-2 text-white font-semibold ">
                         Course content
                     </h2>
                     <div class=" w-full space-y-3">
                         ...
                         @foreach ($course->playlists as $playlist)
                             ...
                             <div class="">
                                 {{-- ? Playlist section --}}
                                 <div class="space-y-3">
                                     <div data-aos="fade-right" data-aos-duration="400" data-aos-delay="1300"
                                         class="playlist group w-full flex justify-between items-center  rounded-md ">
